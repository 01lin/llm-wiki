...
source_type: tweet
source_file: "[[20260412-193717-vllm-llm-compressor-3k-stars-announcement-书签]]"
...
[[20260412-194210-vllm-实体|vLLM]] announced that their **llm-compressor** tool (github.com/vllm-project/llm-compressor) reached 3,000 GitHub stars. The tool enables model [[20260412-194111-quantization-概念|Quantization]] with a "quantize once, serve with vLLM" workflow.

Key supported formats:
- **NVFP4** - NVIDIA's 4-bit floating point format
- **FP8** - 8-bit floating point quantization

Already supports latest models including [[20260412-194210-gemma-实体|Gemma]] 4 and [[20260412-194210-qwen-实体|Qwen]] 3.5 with pre-quantized checkpoints available.
...
- [[20260412-194210-vllm-实体|vLLM]] - serving framework
- [[20260412-194111-quantization-概念|Quantization]] - core technique
- [[20260412-194210-gemma-实体|Gemma]] - Google's model family (Gemma 4)
- [[20260412-194210-qwen-实体|Qwen]] - Alibaba's model family (Qwen 3.5)
- [[20260412-194210-nvidia-实体|NVIDIA]] - hardware vendor (NVFP4 format, DGX Spark)
