...
sources: ["[[20260412-193923-hisparse-turbocharging-sparse-attention-with-hierarchical-memory-来源]]", "[[20260412-193923-lmsys-hisparse-announcement-thread-来源]]", "[[20260412-193923-vllm-llm-compressor-3k-stars-来源]]"]
explored: false
confidence: high
---
...
- Despite reducing compute, sparse attention does **not eliminate the memory capacity bottleneck** - the full [[20260412-194030-kv-cache-概念|KV Cache]] for the entire context must remain in GPU HBM for fast access, even though only a fraction is active
- This makes sparse attention systems often **capacity-bound rather than compute-bound**, limiting batch sizes and throughput
- [[20260412-193923-hisparse-turbocharging-sparse-attention-with-hierarchical-memory-来源|HiSparse]] addresses this by offloading inactive KV cache to host memory, achieving 3-5x throughput gains
...
- [[20260412-194030-kv-cache-概念|KV Cache]] - sparse attention's memory bottleneck centers on KV cache management
- [[Inference Optimization]] - sparse attention is one of several approaches to efficient LLM serving
- [[20260412-194111-quantization-概念|Quantization]] - complementary approach that reduces memory per token rather than reducing token count
- [[20260412-194210-sglang-实体|SGLang]] - serving framework implementing HiSparse for sparse attention acceleration
