...
- **Memory management strategies**: [[20260412-194210-vllm-实体|vLLM]]'s PagedAttention, [[20260412-194210-sglang-实体|SGLang]]'s RadixAttention, and now [[20260412-193923-hisparse-turbocharging-sparse-attention-with-hierarchical-memory-来源|HiSparse]]'s hierarchical offloading
- [[20260412-194111-quantization-概念|Quantization]] of KV cache (e.g., FP8, NVFP4) reduces per-token memory but doesn't change the linear scaling
- [[20260412-194030-sparse-attention-概念|Sparse Attention]] reduces compute but the full KV cache must still reside in memory unless hierarchical management is used

## How It Connects

- [[20260412-194030-sparse-attention-概念|Sparse Attention]] - reduces which KV entries are accessed but not which are stored
- [[20260412-194111-quantization-概念|Quantization]] - reduces the precision/size of stored KV entries
- [[Inference Optimization]] - KV cache management is central to serving efficiency
- [[20260412-194111-prefill-decode-disaggregation-概念|Prefill-Decode Disaggregation]] - architectural approach that separates KV cache generation from consumption
