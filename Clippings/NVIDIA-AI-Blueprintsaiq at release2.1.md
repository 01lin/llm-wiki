---
title: "NVIDIA-AI-Blueprints/aiq at release/2.1"
source: "https://github.com/NVIDIA-AI-Blueprints/aiq/tree/release/2.1"
author:
published:
created: 2026-05-24
description: "The AI-Q NVIDIA Blueprint is an open reference example for building intelligent AI agents that connect to your enterprise data, reason using state-of-the-art models, and deliver trusted business insights. - NVIDIA-AI-Blueprints/aiq at release/2.1"
tags:
  - "clippings"
---
...
[![AI-Q Architecture](https://github.com/NVIDIA-AI-Blueprints/aiq/raw/release/2.1/docs/assets/AIQ-arch-light.png)](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/docs/assets/AIQ-arch-light.png)
...
- **Deployment options** - Deployment assets for a [docker compose](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/deploy/compose) as well as [helm deployment](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/deploy/helm/deployment-k8s).
...
For detailed installation instructions, refer to [Installation -- Hardware Requirements](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/docs/source/get-started/installation.md#hardware-requirements).
...
Each agent can be run individually or as part of the orchestrated workflow. For detailed architecture documentation, refer to [Architecture](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/docs/source/architecture/overview.md).
...
> **Note:** Depending on your usecase, deep research report quality can be enhanced by enabling searching across academic research papers. We use Serper for this. If you want to use paper search, follow the steps in the [Customization guide](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/docs/source/customization/tools-and-sources.md#disabling-a-tool) to enable it.
...
The web UI source is in `frontends/ui/`. Refer to [frontends/ui/README.md](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/frontends/ui/README.md) for more details.
...
Endpoints, SSE streaming, and debug console: refer to [frontends/aiq\_api/README.md](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/frontends/aiq_api/README.md).
...
| --- | --- | --- | --- |
| 0 | [Getting Started with AI-Q](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/docs/notebooks/0_Getting_Started_with_AIQ.ipynb) | Full blueprint overview — environment setup, orchestrated workflow (intent routing, shallow and deep research), and Docker Compose deployment | `NVIDIA_API_KEY`; optionally `TAVILY_API_KEY`, `SERPER_API_KEY` |
| 1 | [Deep Researcher — Web Search](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/docs/notebooks/1_Deep_Researcher_Web_Search.ipynb) | Deep researcher in depth — Python API, `nat run`, and end-to-end evaluation against the DeepResearch Bench with `nat eval` | Notebook 0 completed; `NVIDIA_API_KEY`, `TAVILY_API_KEY`, `SERPER_API_KEY`; OpenAI or Gemini key for the judge model |
| 2 | [Deep Researcher — Customization](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/docs/notebooks/2_Deep_Researcher_Customization.ipynb) | Extending the deep researcher — adding paper search, assigning different LLMs per agent role, editing prompts, and enabling the knowledge layer | Notebooks 0 and 1 completed; `NVIDIA_API_KEY`, `TAVILY_API_KEY`, `SERPER_API_KEY` |
...
- [Deep Research Bench README](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/frontends/benchmarks/deepresearch_bench/README.md)
- [FreshQA README](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/frontends/benchmarks/freshqa/README.md)

## Development

For development, contribution, and documentation, refer to:

- **[Development and Contributing](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/docs/source/contributing/index.md)**: Setup, testing, PR workflow, sign-off/DCO
- **[Tutorial Notebooks](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/docs/notebooks)**: Getting started overview, deeper dive, and customization notebooks
- **[Architecture](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/docs/source/architecture/overview.md)**: Component details and data flow
- **[Customization](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/docs/source/customization/index.md)**: Configuration and customization options
- **[Knowledge Layer Setup](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/sources/knowledge_layer/KNOWLEDGE-LAYER-SETUP.md)**: RAG backends and document ingestion
- **[Agent Skills](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/docs/source/integration/agent-skills.md)**: Install the portable AI-Q research skill in compatible coding harnesses
- **[Skills and Sandbox Example](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/docs/source/examples/skills-sandbox/index.md)**: Run deep research with built-in skills and Modal sandbox execution
- **[Profiling and Cost Analysis](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/docs/source/profiling/index.md)**: Generate tokenomics and latency reports from NAT profiler traces
- **[Docs index](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/docs/README.md)**: Full documentation list and component docs
- **[Changelog](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/docs/source/resources/changelog.md)**: Version history and changes
...
- **Skills & Sandboxing:** Support built-in deep research skills with job-scoped sandbox execution.
...
This project will download and install additional third-party open source software projects. Review the license terms of these open source projects before use, found in [LICENSE-THIRD-PARTY](https://github.com/NVIDIA-AI-Blueprints/aiq/blob/release/2.1/LICENSE-THIRD-PARTY).
